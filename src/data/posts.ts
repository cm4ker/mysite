...
После этого нужно было выбрать шрифт - я сразу же вспомнил про [exalidraw](https://excalidraw.com) - крутой проект про рисования диаграм в приятном человеческом стиле
...
Также немного времени ушло на посмотреть код.
